					...
					<tr>
						<td bgcolor="#ffffff" style="padding: 20px 40px 5px 40px;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td >
										<span style="font-size:22px; line-height:36px; color:#007cf7; margin:0; font-family: Google Sans, sans-serif;">Nuevo usuario registrado a la plataforma</span> <br><br>

										<span style="font-size:16px; margin:0; font-family: Google Sans, sans-serif;">Nombre de usuario: <?php echo $user['nick'] ?></span>
										<br>
										<span style="font-size:16px;  margin:0; font-family: Google Sans, sans-serif;">Correo electrónico: <?php echo $user['email'] ?></span>
										<br>
										<span style="font-size:16px;  margin:0; font-family: Google Sans, sans-serif;">Teléfono: <?php echo $player['phone'] ?></span>
										<br>
										<span style="font-size:16px;  margin:0; font-family: Google Sans, sans-serif;">Identificación: <?php echo $player['document_type'] . " " . $player['document_number'] ?></span>
										<br>
										<span style="font-size:16px;  margin:0; font-family: Google Sans, sans-serif;">Nombre(s): <?php echo $player['name'] ?></span>
										<br>
										<span style="font-size:16px; margin:0; font-family: Google Sans, sans-serif;">Apellido(s): <?php echo $player['lastname'] ?></span>
